...
export class RevisionComponent implements OnInit {
    ...
    constructor(private http: HttpClient, private chRef: ChangeDetectorRef, private modalService: NgbModal) {
        const table_producto: any = $("#soporte_garantia_devolucion_garantia_revision");

        this.datatable = table_producto.DataTable();
    }

    ngOnInit() {
        this.http.get(`${backend_url}soporte/garantia-devolucion/garantia/revision/data`)
            .subscribe(
                res => {
                    if (res['code'] == 200) {
                        ...
                        const table: any = $("#soporte_garantia_devolucion_garantia_revision");
    ...
    guardarDocumento() {
        ...
        this.http.post(`${backend_url}soporte/garantia-devolucion/garantia/revision/guardar`, form_data)
            .subscribe(
                res => {
                    swal({
                        title: "",
