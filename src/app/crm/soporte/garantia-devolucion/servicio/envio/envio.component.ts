...
export class EnvioComponent implements OnInit {
    ...
    constructor(private http: HttpClient, private chRef: ChangeDetectorRef, private modalService: NgbModal) {
        const table_producto: any = $("#soporte_garantia_devolucion_servicio_envio");

        this.datatable = table_producto.DataTable();
    }

    ngOnInit() {
        this.http.get(`${backend_url}soporte/garantia-devolucion/servicio/envio/data`)
            .subscribe(
                res => {
                    ...
                    const table: any = $("#soporte_garantia_devolucion_servicio_envio");
    ...
    guardarDocumento() {
        ...
        this.http.post(`${backend_url}soporte/garantia-devolucion/servicio/envio/guardar`, form_data)
            .subscribe(
                res => {
                    swal({
                        title: "",
