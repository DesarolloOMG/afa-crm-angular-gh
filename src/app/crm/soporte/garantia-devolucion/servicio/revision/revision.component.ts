...
export class RevisionComponent implements OnInit {
    ...
    constructor(private http: HttpClient, private chRef: ChangeDetectorRef, private modalService: NgbModal) {
        const table_producto: any = $("#soporte_garantia_devolucion_servicio_revision");

        this.datatable = table_producto.DataTable();
    }

    ngOnInit() {
        this.http.get(`${backend_url}soporte/garantia-devolucion/servicio/revision/data`)
            .subscribe(
                res => {
                    if (res['code'] == 200) {
                        ...
                        const table: any = $("#soporte_garantia_devolucion_servicio_revision");
    ...
    guardarDocumento() {
        ...
        this.http.post(`${backend_url}soporte/garantia-devolucion/servicio/revision/guardar`, form_data)
            .subscribe(
                res => {
                    swal({
                        title: "",
