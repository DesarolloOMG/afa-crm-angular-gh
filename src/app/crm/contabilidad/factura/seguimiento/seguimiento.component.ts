...
export class SeguimientoComponent implements OnInit {
    ...
    buscarVenta() {
        ...
        this.http.get(`${backend_url}contabilidad/facturas/seguimiento/data/${this.data.documento}`)
            .subscribe(
                res => {
                    if (res['code'] != 200) {
                    ...
                    if (res['code'] == 200) {
                        ...
                        this.data.seguimiento_anterior = res['venta'].seguimiento;
                    }
                },
                response => {
                    swal({
    ...
    guardarSeguimiento() {
        ...
        this.http.post(`${backend_url}contabilidad/facturas/seguimiento/guardar`, form_data)
            .subscribe(
                res => {
                    swal({
                        title: "",
