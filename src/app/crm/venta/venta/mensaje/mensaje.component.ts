...
export class MensajeComponent implements OnInit {
    ...
    ngOnInit() {
        this.http.get(`${backend_url}venta/venta/mensaje/data`)
            .subscribe(
                res => {
                    if (res['code'] == 200)
        ...
        for (var i = 0, len = files.length; i < len; i++) {
            ...
            reader.onload = (function (f) {
                return function (e) {
                    ...
                    if (extension != 'xlsx') {
                        swal("", "El archivo seleccionado no contiene la extension XLXS.", "error");
    ...
    makeRequest(event) {
        ...
        this.http.post(`${backend_url}venta/venta/mensaje`, form_data)
            .subscribe(
                res => {
                    swal({
                        title: "",
