...
export class CrearComponent implements OnInit {
                                    ...
                                    .subscribe(
                                        (res) => {
                                            if (
                                                ...
                                                if (this.busqueda_xml) {
                                                    swal({
                                                        title: '',
                                                        type: 'question',
                                                        html: 'No se encontró el proveedor registrado, ¿Deseas darlo de alta con los datos obtenidos del XML?',
                                                        ...
                                                        await new Promise(
                                                            (
                                                                ...
                                                                this.http
                                                                    .get(
                                                                        `${backend_url_erp}api/adminpro/Consulta/RegimenFiscal/${tipo}`
                                                                    )
                                                                    .subscribe(
                                                                        (
                                                                            res
                                                        ...
                                                        if (
                                                            ...
                                                            swal({
                                                                title: '',
                                                                type: 'error',
                                                                html: 'No se encontró el regimen fiscal del proveedor, favor de contactar a un administrador',
                                                            });
                                                        ...
                                                        this.http
                                                            .post(
                                                                `${backend_url}compra/proveedor/guardar`,
                                                                form_data
                                                            )
                                                            .subscribe(
                                                                (res) => {
    ...
    cambiarEmpresa() {
        ...
        this.http
            .get(`${backend_url_erp}api/adminpro/Pedimentos/${empresa.bd}`)
            .subscribe(
                (res: any) => {
                    this.pedimentos = res.map((pedimento) => {
                        return {
                            id: pedimento.pedimentoid,
                            value: pedimento.pedimentoid,
                            label: pedimento.pedimento,
                        };
                    });
                },
                (response) => {
